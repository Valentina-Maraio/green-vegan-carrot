const greenVeganCarrot = {
    ...
    searchCall: `https://api.spoonacular.com/recipes/complexSearch?apiKey=${process.env.REACT_APP_API_KEY}&diet=vegan&addRecipeInformation=true&addRecipeInformation=true&addRecipeNutrition&`, 
  }
